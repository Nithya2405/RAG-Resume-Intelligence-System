...
BASE_PATH = r"/content/drive/MyDrive/Colab Notebooks/RESUME SCREENING GENAI WITH RAG CHATBOT/RAG MODEL CHATBOT RESUME/Rag_model_and_chatbot"
...
def build_rag_chain():
    ...
    # LLM
    llm = ChatGroq(
        groq_api_key="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",
